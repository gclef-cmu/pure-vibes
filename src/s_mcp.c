...
#define MCP_SERVER_NAME      "pure-data"
...
static cJSON *mcp_prop_int(const char *desc)
{
    cJSON *p = cJSON_CreateObject();
...
static cJSON *mcp_prop_bool(const char *desc)
{
    cJSON *p = cJSON_CreateObject();
...
static cJSON *mcp_make_schema(const char *required[], int nrequired)
{
...
static void mcp_schema_add_prop(cJSON *schema, const char *name, cJSON *prop)
{
...
static cJSON *mcp_build_tools_list(void)
{
